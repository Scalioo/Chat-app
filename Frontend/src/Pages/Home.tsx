...
const Home = () => {
  ...
  useSocketsetup(setfriends, setmessages, setRequests, socket)

  return (
    <Friends.Provider value={{ Mainuser, setMainuser, friends, setfriends, requests, setRequests }}>
      <SocketContext.Provider value={{ socket }}>
        <main className='grid h-screen overflow-hidden lg:grid-cols-[2fr_9fr] bg-formbg'>
          <Sidebar />
          <Hamburger />
